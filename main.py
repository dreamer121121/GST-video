...
def save_checkpoint(state, is_best, epoch):
	torch.save(state, '%s/%s_%dcheckpoint.pth.tar' % (os.path.join(args.checkpoint_dir,'checkpoint'), store_name,epoch))
	if is_best:
		shutil.copyfile('%s/%s_%dcheckpoint.pth.tar' % (os.path.join(args.checkpoint_dir,'checkpoint'), store_name,epoch),'%s/%s_best.pth.tar' % (os.path.join(args.checkpoint_dir,'checkpoint'), store_name))
